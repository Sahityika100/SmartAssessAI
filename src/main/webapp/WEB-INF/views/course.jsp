...
<main class="content-wrapper">
    <header class="header-flex">
        <div>
            ...
            <p style="color: var(--text-body);">Welcome back, ready to master something new?</p>
        </div>
    ...
    <div class="grid-container">
        ...
        <c:forEach var="course" items="${courses}" varStatus="status">
            ...
            <div class="glass-card">
                ...
                <div class="icon-circle" style="background: rgba(99,102,241,0.1);">
                    <i data-lucide="${status.index % 3 == 0 ? 'code' : status.index % 3 == 1 ? 'book-open' : 'cpu'}" color="#6366f1"></i>
                </div>
                ...
                <a href="/courses/enroll/${course.id}/${course.courseName}" class="btn-modern">
                    Start Learning
                </a>
